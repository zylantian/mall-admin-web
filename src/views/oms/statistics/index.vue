  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="订单区域" min-width="13%" align="center">
          <template slot-scope="scope">{{scope.row.salesName}}</template>
        </el-table-column>
        <el-table-column label="订单编号" min-width="20%" align="center">
        ...
        <el-table-column label="收件地址" min-width="15%">
          <template slot-scope="scope">{{scope.row.receiverDetailAddress}}</template>
        </el-table-column>
        <el-table-column label="用户姓名" min-width="15%">
          <template slot-scope="scope">{{scope.row.memberUsername}}</template>
        </el-table-column>
        <el-table-column label="手机号码" min-width="15%">
